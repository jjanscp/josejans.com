...
export const bio = {
  ...
  research: {
    en: `My research sits at the intersection of <strong>comparative politics, transitional justice, and the political sociology of law</strong>. Drawing on a decade of frontline practice in Colombia, I pursue three interconnected lines of inquiry.\n\nThe first concerns <strong>courts, accountability institutions, and macro-criminal violence</strong>. I study how states and armed actors jointly produce violence and criminal structures — and how accountability institutions are designed to investigate and disrupt those networks. My current project develops the concept of the <em>Systemic Research Approach</em>: a model of judicial governance that enables transitional justice institutions to reconstruct <strong>macro-criminal patterns</strong> and achieve upward accountability against high-ranking commanders. Using Colombia's JEP as a paradigmatic case alongside five comparators (Guatemala's CICIG, Cambodia's ECCC, Sierra Leone's SCSL, Argentina's ESMA mega-cause, and the ICC), I analyze when and why partial institutional configurations fail to produce structural documentation of state-criminal networks.\n\nThe second line concerns <strong>public interest litigation, rights mobilization, and social movements</strong>. I examine how civil society organizations — particularly human rights organizations using Participatory Action Research — transform legal knowledge production within transitional justice institutions and constitutional courts, blurring traditional boundaries between legal, academic, and community-generated knowledge.\n\nA third thread addresses <strong>drug policy, prohibition, and health-rights frameworks</strong> in Latin America, examining how legal mobilization challenges prohibitionist regimes through constitutional and international human rights law.\n\nMethodologically, I combine participatory action research, archival analysis, macro-historical comparison, discourse analysis, and ethnographic fieldwork.`,
    es: `Mi investigación se ubica en la intersección de la <strong>política comparada, la justicia transicional y la sociología política del derecho</strong>. A partir de una década de práctica de primera línea en Colombia, desarrollo tres líneas de indagación interconectadas.\n\nLa primera concierne a <strong>las cortes, las instituciones de responsabilidad penal y la violencia macro-criminal</strong>. Estudio cómo los estados y actores armados co-producen violencia y estructuras criminales — y cómo las instituciones de justicia investigan y desarticulan esas redes. Mi proyecto actual desarrolla el concepto de <em>Enfoque de Investigación Sistémica</em> (EIS): un modelo de diseño institucional que permite a los tribunales de justicia transicional reconstruir <strong>patrones de criminalidad estructural</strong> y alcanzar la responsabilización ascendente de mandos superiores. Usando la JEP colombiana como caso paradigmático y cinco comparadores (CICIG de Guatemala, ECCC de Camboya, TSSL de Sierra Leona, mega-juicio ESMA en Argentina y la CPI), analizo cuándo y por qué los diseños institucionales parciales no logran producir documentación sistémica de redes Estado-crimen.\n\nLa segunda línea concierne al <strong>litigio de interés público, la movilización de derechos y los movimientos sociales</strong>. Examino cómo las organizaciones de la sociedad civil — en particular las que emplean Investigación-Acción Participativa — transforman la producción de conocimiento jurídico dentro de instituciones de justicia transicional y cortes constitucionales, disolviendo las fronteras entre el saber jurídico, académico y comunitario.\n\nUn tercer hilo aborda la <strong>política de drogas, la prohibición y los enfoques de salud y derechos</strong> en América Latina, examinando cómo la movilización jurídica desafía los regímenes prohibicionistas a través del derecho constitucional e internacional.\n\nMetodológicamente combino investigación-acción participativa, análisis de archivos, comparación macro-histórica, análisis de discurso y trabajo de campo etnográfico.`,
  },
