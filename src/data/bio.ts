...
export const bio = {
  ...
  research: {
    en: `My research sits at the intersection of <strong>comparative politics, constitutional law, and the political sociology of law</strong>. Drawing on a decade of frontline practice in Colombia, I pursue three interconnected lines of inquiry.\n\nThe first concerns <strong>criminal governance, courts, and state accountability</strong>. I study how states and armed actors jointly produce violence and criminal structures — and how accountability institutions are designed to investigate and disrupt those networks. I develop the concept of the <em>Systemic Research Approach</em>: a model of judicial governance that enables accountability institutions to reconstruct <strong>macro-criminal patterns</strong> and achieve upward accountability against high-ranking commanders. I analyze when and why partial institutional configurations fail to produce structural documentation of state-criminal networks, and how alternative designs succeed. I am a member of the <strong>Working Group on Criminal Politics</strong>, a collaborative initiative bringing together graduate students from <strong>Northwestern, the University of Chicago, and UIC</strong> under the leadership of <strong>Andreas Feldmann and Juan Albarracín</strong>, advancing a shared research agenda on the politics of violence, criminal governance, and the state in Latin America.\n\nThe second line concerns <strong>constitutional law, civil rights, and democracy</strong>. I examine how courts, civil society organizations, and social movements contest the boundaries of rights and shape democratic institutions — with particular attention to how human rights organizations using Participatory Action Research transform legal knowledge production within constitutional and transitional justice institutions, blurring traditional boundaries between legal, academic, and community-generated knowledge.\n\nA third thread addresses <strong>drug policy, prohibition, and health-rights frameworks</strong> in Latin America, examining how legal mobilization challenges prohibitionist regimes through constitutional and international human rights law.\n\nMethodologically, I combine participatory action research, archival analysis, macro-historical comparison, discourse analysis, and ethnographic fieldwork.`,
    es: `Mi investigación se ubica en la intersección de la <strong>política comparada, el derecho constitucional y la sociología política del derecho</strong>. A partir de una década de práctica de primera línea en Colombia, desarrollo tres líneas de indagación interconectadas.\n\nLa primera concierne a la <strong>gobernanza criminal, las cortes y la rendición de cuentas del Estado</strong>. Estudio cómo los estados y actores armados co-producen violencia y estructuras criminales — y cómo las instituciones de rendición de cuentas se diseñan para investigar y desarticular esas redes. Desarrollo el concepto de <em>Enfoque de Investigación Sistémica</em> (EIS): un modelo de diseño institucional que permite a las instituciones de rendición de cuentas reconstruir <strong>patrones de criminalidad estructural</strong> y alcanzar la responsabilización ascendente de mandos superiores. Analizo cuándo y por qué los diseños institucionales parciales no logran producir documentación sistémica de redes Estado-crimen, y cómo otros diseños sí lo logran. Integro el <strong>Grupo de Trabajo en Criminal Politics</strong>, una iniciativa colaborativa que reúne a estudiantes doctorales de <strong>Northwestern, la Universidad de Chicago y UIC</strong> bajo el liderazgo de <strong>Andreas Feldmann y Juan Albarracín</strong>, y que desarrolla una agenda conjunta sobre la política de la violencia, la gobernanza criminal y el Estado en América Latina.\n\nLa segunda línea concierne al <strong>derecho constitucional, los derechos civiles y la democracia</strong>. Examino cómo las cortes, las organizaciones de la sociedad civil y los movimientos sociales disputan los contornos de los derechos y moldean las instituciones democráticas — con particular atención a cómo las organizaciones de derechos humanos que emplean Investigación-Acción Participativa transforman la producción de conocimiento jurídico dentro de las cortes constitucionales y las instituciones de justicia transicional, disolviendo las fronteras entre el saber jurídico, académico y comunitario.\n\nUn tercer hilo aborda la <strong>política de drogas, la prohibición y los enfoques de salud y derechos</strong> en América Latina, examinando cómo la movilización jurídica desafía los regímenes prohibicionistas a través del derecho constitucional e internacional.\n\nMetodológicamente combino investigación-acción participativa, análisis de archivos, comparación macro-histórica, análisis de discurso y trabajo de campo etnográfico.`,
  },
