...
export const bio = {
  ...
  short: {
    ...
    es: `Soy estudiante de doctorado en Ciencia Política en la Universidad de Illinois en Chicago (UIC) y <strong>becario Fulbright–MinCiencias</strong> (2025–2030). Mi trabajo es <em>anfibio</em>: se mueve entre el archivo y la sala de audiencias, entre la teoría constitucional y el trabajo de campo, entre Colombia y Chicago, y se apoya en <strong>métodos mixtos</strong> que combinan investigación cualitativa (archivos, etnografía, comparación de casos) con análisis cuantitativo. Tras una década de ejercicio profesional en el centro del proceso de transición, la justicia transicional, los derechos humanos y el litigio de interés público, retomo ahora las preguntas teóricas que la práctica me obligó a formular.`,
  },
  ...
  research: {
    ...
    es: `<p style="font-family:var(--font-serif);font-size:1.05rem;line-height:1.8;color:rgba(215,209,161,0.9);margin-bottom:var(--sp-5);">Mi investigación se ubica en la intersección de la <strong>política comparada, el derecho constitucional y la sociología política del derecho</strong>, y está animada por una década de trabajo jurídico en el corazón del proceso de paz colombiano. Trabajo con <strong>métodos mixtos</strong>: articulo herramientas cualitativas (investigación-acción participativa, análisis de archivos, análisis del discurso y trabajo de campo etnográfico) con análisis cuantitativo y comparación macrohistórica entre casos.</p><div class="research-pillars"><div class="research-pillar"><div class="pillar-num">01</div><div class="pillar-title">Gobernanza criminal y rendición de cuentas del Estado</div><p class="pillar-body">Cómo los Estados y los actores armados co-producen violencia y redes criminales, y cómo pueden diseñarse las instituciones de rendición de cuentas para investigarlas y desarticularlas. Desarrollo el <em>Enfoque de Investigación Sistémica</em> (EIS), un modelo de gobernanza judicial cuyo diseño institucional integrado hace posible la rendición de cuentas ascendente frente a los mandos superiores. Miembro del <strong>Working Group on Criminal Politics</strong> (Northwestern · U. of Chicago · UIC; Feldmann y Albarracín).</p></div><div class="research-pillar"><div class="pillar-num">02</div><div class="pillar-title">Derecho constitucional, derechos civiles y democracia</div><p class="pillar-body">Cómo las cortes, las organizaciones de la sociedad civil y los movimientos sociales disputan los contornos de los derechos y reconfiguran las instituciones democráticas. Me interesa en particular la manera en que la investigación-acción participativa transforma la producción de conocimiento jurídico en las cortes constitucionales y en la justicia transicional, difuminando las fronteras entre el saber académico, el jurídico y el comunitario.</p></div><div class="research-pillar"><div class="pillar-num">03</div><div class="pillar-title">Política de drogas, prohibición y enfoque de salud-derechos</div><p class="pillar-body">Cómo la movilización jurídica en América Latina cuestiona los regímenes prohibicionistas desde el derecho constitucional y el derecho internacional de los derechos humanos: el consumo se resignifica como un asunto de salud pública y de derechos, y se abren espacios para la reducción de daños y la justicia restaurativa dentro de los sistemas penales.</p></div></div>`,
  },
  ...
  researchBrief: {
    ...
    es: `Mi investigación se ubica en la intersección de la <strong>política comparada, el derecho constitucional y la sociología política del derecho</strong>, y pregunta cómo las instituciones de rendición de cuentas enfrentan la violencia estatal y la gobernanza criminal en América Latina — una pregunta que abordo con <strong>métodos mixtos</strong>, combinando archivos, etnografía e investigación-acción participativa con análisis comparado cuantitativo. A las preguntas teóricas que organizan mi trabajo doctoral llego desde una década de ejercicio jurídico en el centro del proceso de paz colombiano.`,
  },
